    ...
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="font-weight-bold mb-0">Create New Role</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   ...
                                   placeholder="e.g., Manager, Staff, Editor" required>
                            @error('name')
                        ...
                        <div class="alert alert-info">
                            ...
                            <small>Select the permissions this role should have from the list on the right.</small>
                        </div>
